...
const Home = () => (
    <>
        ...
        <footer className="flex flex-col justify-center items-center gap-8 py-8 px-8 bg-gray-dark-700">
            ...
            <p className="pt-8 mx-auto md:px-8 max-w-3xl text-justify">
                ...
                <a className="underline underline-offset-4 hover:text-green-dark hover:decoration-green-dark" href="https://github.com/UjjwalSk" target="_blank" rel="noreferrer">UjjwalSk</a>, please go and check their profile.
                <br /><br />
